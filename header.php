		...
		<header id="banner" class="<?php echo roots_container_class; ?>" role="banner">
			<div class="container">
			  <?php if( is_front_page() ) { ?>
				<a id="logo" class="front-logo" href="<?php echo home_url(); ?>/"><img src="<?php echo get_template_directory_uri(); ?>/img/logo.png" width="950" height="160" alt="<?php bloginfo('name'); ?>"></a>
				<div id="logo-call">
  				<ul class="logo-list">
  				  <li>Archives <strong>everything</strong> you can imagine.</li>
  				  <li>No pesky UI to worry about!</li>
  				  <li>Whitens teeth, mows lawns, cares.</li>
  				</ul>
